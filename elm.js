...
var $author$project$Main$GoToLogin = function (a) {
	return {$: 'GoToLogin', a: a};
};
var $author$project$Main$GoToSettings = function (a) {
	return {$: 'GoToSettings', a: a};
};
...
var $author$project$Main$logout = $elm$core$Platform$Cmd$none;
...
var $author$project$Route$routeToParts = function (route) {
	switch (route.$) {
		case 'Root':
			return _List_Nil;
		case 'Home':
...
var $author$project$Route$routeToString = function (route) {
	return '#/' + A2(
		$elm$core$String$join,
		'/',
		$author$project$Route$routeToParts(route));
};
			...
			switch (maybeRoute.a.$) {
				...
				case 'Settings':
					...
					return A3(
						...
						$author$project$Main$GoToSettings,
						$author$project$Page$Settings$init(session));
				default:
					var _v5 = maybeRoute.a;
					return _Utils_Tuple2(model, $author$project$Main$logout);
			}
		} else {
			return _Utils_Tuple2(
...
var $author$project$Session$fromUser = F2(
	function (key, maybeUser) {
		if (maybeUser.$ === 'Just') {
			var aUser = maybeUser.a;
			return A2($author$project$Session$LoggedIn, key, aUser);
		} else {
	...
	function (_v0, url, navKey) {
		return A2(
			...
			$author$project$Main$Redirect(
				A2($author$project$Session$fromUser, navKey, $elm$core$Maybe$Nothing)));
	});
...
var $author$project$Page$Settings = {$: 'Settings'};
...
var $author$project$Page$viewMenu = F2(
	function (page, maybeUser) {
		...
		if (maybeUser.$ === 'Just') {
			...
			var username = $author$project$User$username(user);
			return _List_fromArray(
				[
					A2(
					linkTo,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Pages Sample')
								])),
							A2(
							$elm$html$Html$ul,
							_List_fromArray(
							...
							A2(
								...
								A2($author$project$Page$viewMenu, page, maybeUser)))
						]))
				]));
	});
var $author$project$Page$view = F3(
	function (maybeUser, page, _v0) {
		var title = _v0.title;
		var content = _v0.content;
		return {
			body: A2(
				$elm$core$List$cons,
				A2($author$project$Page$viewHeader, page, maybeUser),
				A2(
					$elm$core$List$cons,
					content,
					_List_fromArray(
...
var $author$project$Page$Home$view = function (model) {
	return {
		content: A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Homepage content')
				])),
		title: 'Home'
	};
};
var $author$project$Page$Login$view = function (model) {
	return {
		content: A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Login content')
				])),
		title: 'Login'
	};
};
var $author$project$Page$NotFound$view = {
	content: A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Sorry, that page is not found.')
			])),
...
var $author$project$Page$Settings$view = function (model) {
	return {
		content: A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Settings content')
				])),
		title: 'Settings'
	};
};
var $author$project$Main$view = function (model) {
	var user = $author$project$Session$user(
		$author$project$Main$toSession(model));
	var viewPage = F3(
		function (page, toMsg, config) {
			var _v1 = A3($author$project$Page$view, user, page, config);
			var title = _v1.title;
			var body = _v1.body;
			return {
				body: A2(
	...
	var _v0 = A2($elm$core$Debug$log, 'view', model);
	switch (_v0.$) {
		case 'Redirect':
			return A3($author$project$Page$view, user, $author$project$Page$Other, $author$project$Page$NotFound$view);
		case 'NotFound':
			return A3($author$project$Page$view, user, $author$project$Page$Other, $author$project$Page$NotFound$view);
		case 'Home':
			var home = _v0.a;
